...
OpenAI Platformで発行されたdomain tokenは、公開repo mainの `plugins/ai-akari-decision-pack/openai-apps-challenge.txt` の1行へ反映します。`ai-akari.ai` のchallenge routeがこの1行をそのまま返すため、token反映ごとの再デプロイは不要です。
...
- Support: https://ai-akari.ai/plugin-support
